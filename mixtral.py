...
second_prompt = f"""
{system}\n
Based on the story structures you generated:

{first_response}

Generate 10 different JSON Schemas using the Hierarchical Data Structure format each has different "story" theme"""
